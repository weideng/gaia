Keyboards['zh-Hans-Pinyin'] = {
  ...
  keys: [
    [
      ...
      { value: '12&', keyCode: -21, ratio: 1.5, singleImeRatio: 2, className: 'switch-key' },
      { value: '&nbsp', keyCode: KeyEvent.DOM_VK_SPACE, ratio: 6 },
      { value: '↵', ratio: 2.5, singleImeRatio: 2, keyCode: KeyEvent.DOM_VK_RETURN }
    ]
  ]
};
...
Keyboards['zh-Hans-Pinyin-Symbol-Ch-1'] = {
  ...
  keys: [
    [
      ...
      { value: 'ABC', ratio: 1.5, singleImeRatio: 2, keyCode: -11 },
